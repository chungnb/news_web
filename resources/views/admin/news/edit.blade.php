<x-app-layout>
    <section class="w-full m-auto bg-white shadow sm:rounded-lg p-4">
        <h1 class="text-xl font-bold">Cập nhật tin tức</h1>

        <form action="{{ route('admin.news.update', $news->id) }}" method="post" class="mt-6 space-y-6"
            ...
            <div>
                ...
                <x-text-input id="title" name="title" type="text" :value="old('title', $news->title)" class="mt-1 block w-full"
            ...
            <div>
                ...
                <x-text-input id="slug" name="slug" type="text" :value="old('slug', $news->slug)" class="mt-1 block w-full"
                    required />
            ...
            <div class="mt-4">
                ...
                <textarea id="editor" name="content" class="editor-config" oninput="checkSEO()">
                    {{ $news->content }}
                </textarea>
            ...
            <div class="seo_component">
                ...
                <div class="border-[1px] rounded p-3 flex flex-col gap-4 justify-between">
                    <div class="w-full">
                        ...
                        <x-text-input id="heading_seo" name="seo_heading" :value="old('seo_heading', $news->seo_heading)" type="text"
                            class="mt-1 block w-full count_text" oninput="checkSEO()"/>
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="title_seo" name="seo_title" :value="old('seo_title', $news->seo_title)" type="text"
                            class="mt-1 block w-full count_text" oninput="checkSEO()"/>
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="description_seo" name="seo_description" :value="old('seo_description', $news->seo_description)" type="text"
                            class="mt-1 block w-full count_text" oninput="checkSEO()"/>
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="seo_keywords" name="seo_keywords" :value="old('seo_keywords', $news->seo_keywords)" type="text"
                ...
                <div class="border-[1px] rounded p-3 flex flex-col gap-4 justify-between">
                    <div>
                        ...
                        <x-text-input id="primaryKeyword_seo" name="primary_key" type="text" oninput="checkSEO()" class="primary-key-slug mt-1 block w-full"
                            autofocus autocomplete="primary_key" value="{{ old('primary_key', $news->primary_key) }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="secondaryKeyword_seo" name="secondary_key" oninput="checkSEO()" type="text" class="secondary-key-slug mt-1 block w-full"
                            autofocus autocomplete="secondary_key" value="{{ old('secondary_key', $news->secondary_key) }}" />
            ...
            <div class="seo_score_total">
                ...
                <div class="mt-4 xl:w-[14%]">
                        ...
                        <x-text-input id="total-score" name="seo_score" type="text" class="secondary-key-slug mt-1 block" 
                            autofocus autocomplete="total" value="{{ old('seo_score', $news->seo_score) }}" />
            ...
            <div>
                ...
                <select id="category_id" name="category_id"
                    class="mt-2 p-2 xl:w-[35%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div>
                ...
                <div class="shrink-0 my-2">
                    <img id="featured_image_preview" class="h-64 w-128 object-cover rounded-md"
                        src="{{ asset('storage/' . $news->image) }}" alt="Ảnh minh họa" />
                </div>
