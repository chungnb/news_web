<x-app-layout>
    <section class="w-full m-auto bg-white shadow sm:rounded-lg p-4">
        <h1 class="text-xl font-bold">Cập nhật Slide</h1>

        <form action="{{ route('admin.slides.update', $slides->id) }}" method="post" class="mt-6 space-y-6"
            ...
            <div>
                ...
                <div class="shrink-0 my-2">
                    <img id="featured_image_preview" class="h-64 w-128 object-cover rounded-md"
                        src="{{ asset('storage/' . $slides->image) }}" alt="Ảnh minh họa" />
                </div>
            ...
            <div class="mt-4">
                ...
                class="slug-text mt-1 block w-full" :value="old('title', $slides->title)"/>
            ...
            <div class="mt-4">
                ...
                <textarea id="content" class="block mt-1 w-full border-[1px] px-2" type="text" name="content">
                   {{ $slides->content }}
                </textarea>
