<x-app-layout>
    <section class="w-full m-auto bg-white shadow sm:rounded-lg p-4">
        <h1 class="text-xl font-bold">Thêm mới tin tuyển dụng</h1>
        ...
        <form action="{{ route('admin.tuyen-dung.store') }}" method="post" class="mt-6 space-y-6">
            ...
            <div>
                <x-input-label for="title" :value="__('Tiêu đề')" :isRequired="true" />
                <x-text-input id="title" name="title" value="{{ old('title') }}" type="text"
                    class="title-slug mt-1 block w-full" required autofocus />
                <x-input-error class="mt-2" :messages="$errors->get('title')" />
            </div>

            <div>
                <x-input-label for="slug" :value="__('Slug')" />
                <x-text-input id="slug" name="slug" type="hidden" class="slug-text mt-1 block w-full"
                    required />
            ...
            <div class="mt-4">
                <x-input-label for="description" :value="__('Nội dung')" class="mb-2" :isRequired="true" />
            ...
            <div class="seo_component">
                ...
                <div class="border-[1px] rounded p-3 flex flex-col gap-4 justify-between">
                    <div class="w-full">
                        ...
                        <x-text-input id="seo_heading" name="seo_heading" type="text"
                            class="mt-1 block w-full count_text" value="{{ old('seo_heading') }}" />
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="seo_title" name="seo_title" type="text"
                            class="mt-1 block w-full count_text" maxlength="255" value="{{ old('seo_title') }}" />
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="seo_description" name="seo_description" type="text"
                            class="mt-1 block w-full count_text" maxlength="255" value="{{ old('seo_description') }}" />
            ...
            <div class="mt-4">
                <x-input-label for="salary" :value="__('Lương')" :isRequired="true" />

                <x-text-input id="salary" class="block mt-1 w-full" value="{{ old('salary') }}" type="text"
            ...
            <div class="mt-4">
                <x-input-label for="working_time" :value="__('Thời gian làm việc')" :isRequired="true" />

                <x-text-input id="working_time" value="{{ old('working_time') }}" class="block mt-1 w-full"
                    type="text" name="working_time" required />

                <x-input-error :messages="$errors->get('working_time')" class="mt-2" />
            </div>

            <div class="mt-4">
                <x-input-label for="num_of_recruitment" :value="__('Số lượng tuyển')" :isRequired="true" />

                <x-text-input id="num_of_recruitment" value="{{ old('num_of_recruitment') }}" class="block mt-1 w-full"
                    type="number" name="num_of_recruitment" required />

                <x-input-error :messages="$errors->get('num_of_recruitment')" class="mt-2" />
            </div>

            <div class="mt-4">
                <x-input-label for="location" :value="__('Địa chỉ')" :isRequired="true" />

                <x-text-input id="location" value="{{ old('location') }}" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                <x-input-label for="position" :value="__('Chức vụ')" :isRequired="true" />

                <x-text-input id="position" value="{{ old('position') }}" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="contact" value="{{ old('contact_address') }}" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="end_time" value="{{ old('end_time') }}" class="block mt-1 w-full sm:w-[20%]"
                    type="date" min="{{ date('Y-m-d') }}" max="2030-12-31" name="end_time" required />
